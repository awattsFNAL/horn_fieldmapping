...
print('Please enter a filename for this data run (no spaces).')
...
# Begin main loop with file still open to save write time
    ...
    while 1:
        ...
        if variable == 'f':
            ...
            X, Y, Z, xsig, ysig, zsig = readPosition(X_pos, Y_pos, Z_pos)
            get_data(stripline_scope, field_scope, X_pos, Y_pos, Z_pos)
            f.write('')
